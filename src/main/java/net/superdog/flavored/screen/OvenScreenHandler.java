...
import net.superdog.flavored.slot.ModFuelSlot;
import net.superdog.flavored.slot.ModResultSlot;
...
public class OvenScreenHandler extends ScreenHandler {
    ...
    public OvenScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        //
        this.addSlot(new ModFuelSlot(inventory, 0, 49, 62));
        ...
        this.addSlot(new ModResultSlot(inventory, 5, 116, 19));
