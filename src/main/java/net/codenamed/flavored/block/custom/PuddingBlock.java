...
public class PuddingBlock extends HorizontalFacingBlock {
    ...
    public PuddingBlock(Settings settings) {
        super(settings);
    ...
    static {
        ...
        BITES_TO_SHAPE = new VoxelShape[]{
                Stream.of(
                        Block.createCuboidShape(3, 0, 2, 8, 6, 7),
                        Block.createCuboidShape(3, 0, 7, 8, 6, 12),
                        Block.createCuboidShape(8, 0, 2, 13, 6, 7),
                        Block.createCuboidShape(8, 0, 7, 13, 6, 12)
                ...
                VoxelShapes.combineAndSimplify(Block.createCuboidShape(3, 0, 7, 8, 6, 12),
                        Block.createCuboidShape(8, 0, 7, 13, 6, 12), BooleanBiFunction.OR),
