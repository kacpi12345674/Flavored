...
public class DatesBlock extends PlantBlock implements Fertilizable {
    ...
    public DatesBlock(Settings settings) {
        super(settings);
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {BlockPos up = pos.up();BlockState blockState = world.getBlockState(up);
        return blockState.isOf(FlavoredBlocks.PALM_LEAVES);
    }



    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(FlavoredItems.DATES);
    }
