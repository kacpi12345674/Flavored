...
public class CheeseBlock extends HorizontalFacingBlock {
    ...
    protected static ActionResult tryEat(WorldAccess world, BlockPos pos, BlockState state, PlayerEntity player) {
        player.getInventory().insertStack(FlavoredItems.CHEESE_SLICE.getDefaultStack());
    ...
    static {
        ...
        BITES_TO_SHAPE = new VoxelShape[]{
                ...
                Stream.of(
                        Block.createCuboidShape(2, 0, 8, 8, 4, 14),
                        Block.createCuboidShape(8, 0, 8, 14, 4, 14),
                        Block.createCuboidShape(2, 0, 2, 8, 4, 8)
                ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get(),

                VoxelShapes.combineAndSimplify(Block.createCuboidShape(2, 0, 8, 8, 4, 14), Block.createCuboidShape(8, 0, 8, 14, 4, 14), BooleanBiFunction.OR),
